    ...
    <div id="AuthPage" class="w-full h-screen pt-32">
        <div class="w-full">
            ...
            <div class="max-w-[350px] mx-auto px-2 text-white">
                ...
                <button
                    class="flex items-center justify-center gap-3 p-2.5 w-full border rounded-full text-lg font-semibold"
                >
                    <div class="flex items-center gap-2 justify-center">
                        <img class="max-w-[30px] rounded-full" src="/github-logo.png">
                        GitHub
                    </div>
                </button>
            </div>
