        ...
        <div class="py-2 w-full">
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center text-white">
                    ...
                    <div class="ml-2 font-semibold text-[18ox]">{{ post.name }}</div>
                </div>
                ...
                <div @click="isMenu = !isMenu" class="relative">
                    ...
                    >
                        <Icon v-if="isDeleting" name="bi:three-dots" class="text-white" size="18"/>
                        <Icon v-else name="eos-icons:bubble-loading" class="text-white" size="18"/>
                    </button>


                    <div v-if="isMenu" class="absolute border border-gray-600 right-0 z-50 mt-1 rounded">
                        <button
